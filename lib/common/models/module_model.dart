class ModuleModel {
  ...
  ModuleModel.fromJson(Map<String, dynamic> json) {
    ...
    appHomePage = json['app_home_page'];
    appHomePageFullUrl = json['app_home_page_full_url'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['app_home_page'] = appHomePage;
    data['app_home_page_full_url'] = appHomePageFullUrl;
    return data;
  }
}

...
class ConfigModel {
  ...
  String? websocketUrl;
  double? billPaymentPlatformCommissionValue;
  String? billPaymentPlatformCommissionType; // 'percent' or 'fixed'
  double? billPaymentProviderFeeValue;
  String? billPaymentProviderFeeType; // 'percent' or 'fixed'
  int? airtimeStatus;
  int? billPaymentStatus;
  String? airtimeName;
  String? billPaymentName;
  String? airtimeLogo;
  String? airtimeLogoFullUrl;
  String? billPaymentLogo;
  String? billPaymentLogoFullUrl;
  String? homeModuleBanner;
  String? homeModuleBannerFullUrl;
  ...
  ConfigModel({
    ...
    this.websocketUrl,
    this.billPaymentPlatformCommissionValue,
    this.billPaymentPlatformCommissionType,
    this.billPaymentProviderFeeValue,
    this.billPaymentProviderFeeType,
    this.airtimeStatus,
    this.billPaymentStatus,
    this.airtimeName,
    this.billPaymentName,
    this.airtimeLogo,
    this.airtimeLogoFullUrl,
    this.billPaymentLogo,
    this.billPaymentLogoFullUrl,
    this.homeModuleBanner,
    this.homeModuleBannerFullUrl,
  });
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    billPaymentPlatformCommissionValue = (json['bill_payment_platform_commission_value'] as num?)?.toDouble() ?? 0.3;
    billPaymentPlatformCommissionType  = json['bill_payment_platform_commission_type']?.toString() ?? 'percent';
    billPaymentProviderFeeValue        = (json['bill_payment_provider_fee_value'] as num?)?.toDouble() ?? 7.0;
    billPaymentProviderFeeType         = json['bill_payment_provider_fee_type']?.toString() ?? 'fixed';
    airtimeStatus                      = json['airtime_status'] is int ? json['airtime_status'] : (json['airtime_status'] != null ? int.tryParse(json['airtime_status'].toString()) ?? 0 : 0);
    billPaymentStatus                  = json['bill_payment_status'] is int ? json['bill_payment_status'] : (json['bill_payment_status'] != null ? int.tryParse(json['bill_payment_status'].toString()) ?? 0 : 0);
    airtimeName                        = json['airtime_name']?.toString();
    billPaymentName                    = json['bill_payment_name']?.toString();
    airtimeLogo                        = json['airtime_logo']?.toString();
    airtimeLogoFullUrl                 = json['airtime_logo_full_url']?.toString();
    billPaymentLogo                    = json['bill_payment_logo']?.toString();
    billPaymentLogoFullUrl             = json['bill_payment_logo_full_url']?.toString();
    homeModuleBanner                   = json['home_module_banner']?.toString();
    homeModuleBannerFullUrl            = json['home_module_banner_full_url']?.toString();
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['bill_payment_platform_commission_value'] = billPaymentPlatformCommissionValue;
    data['bill_payment_platform_commission_type']  = billPaymentPlatformCommissionType;
    data['bill_payment_provider_fee_value']        = billPaymentProviderFeeValue;
    data['bill_payment_provider_fee_type']         = billPaymentProviderFeeType;
    data['airtime_status']                         = airtimeStatus;
    data['bill_payment_status']                    = billPaymentStatus;
    data['airtime_name']                           = airtimeName;
    data['bill_payment_name']                      = billPaymentName;
    data['airtime_logo']                           = airtimeLogo;
    data['airtime_logo_full_url']                  = airtimeLogoFullUrl;
    data['bill_payment_logo']                      = billPaymentLogo;
    data['bill_payment_logo_full_url']             = billPaymentLogoFullUrl;
    data['home_module_banner']                     = homeModuleBanner;
    data['home_module_banner_full_url']            = homeModuleBannerFullUrl;
    return data;
  }
}

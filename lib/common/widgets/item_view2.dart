...
import 'package:sixam_mart/common/widgets/item_shimmer2.dart';
...
import '../../features/home/widgets/web/store_card_widget2.dart';
...
class ItemsView2 extends StatefulWidget {
  ...
  @override
  State<ItemsView2> createState() => _ItemsView2State();
}

class _ItemsView2State extends State<ItemsView2> {
  @override
      ...
      !isNull
        ...
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
          ...
          ResponsiveHelper.isDesktop(context) && widget.isStore
              ...
              : 268
              : 130,
          crossAxisCount: widget.stores != null
              ? 1 // When showing stores, use a single column.
              : ResponsiveHelper.isMobile(context)
              ? 2 // When on mobile and showing items, use two columns.
              : ResponsiveHelper.isDesktop(context)
              ? 3 // When on desktop, use three columns for items.
              : 2, // Default to two columns for other cases.
        ),

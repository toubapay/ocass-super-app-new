...
class ModuleHeaderWithBackground extends StatefulWidget {
  final Widget? child;
  ...
  @override
  State<ModuleHeaderWithBackground> createState() =>
      _ModuleHeaderWithBackgroundState();
}

class _ModuleHeaderWithBackgroundState
    extends State<ModuleHeaderWithBackground> {
            ...
            children: [
                ...
                Positioned.fill(
                  child: FittedBox(
                    ...
                    child: SizedBox(
                      ...
                      height: _videoController!.value.size.height * .6,
              ...
              if (showImage)
                Positioned.fill(
                  child: CachedNetworkImage(
                    // height: _videoController!.value.size.height * .4,
              ...
              Column(
                ...
                children: [
                  ...
                  SizedBox(height: usePrimaryColor ? 20 : 200),

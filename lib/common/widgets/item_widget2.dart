import 'package:sixam_mart/common/widgets/cart_count_button.dart';
    ...
    return Stack(
      children: [
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    ...
                                    (isStore
                                      ...
                                      maxLines: !isStore && (item!.ratingCount! > 0) ? 2 :1,
                                      overflow: TextOverflow.ellipsis,
                                    )
                                        : const SizedBox(),
        ...
        (!isStore && isCornerTag! == false)
            ...
            top: 10,
            left: 5,
            child: DiscountTag(discount: discount, discountType: discountType)
          // CornerDiscountTag(
          //   bannerPosition: ltr

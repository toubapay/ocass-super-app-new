...
import 'package:sixam_mart/features/bill_payment/screens/bill_payment_screen.dart';
...
import 'package:sixam_mart/features/airtime/screens/airtime_screen_stepper.dart';
...
class RouteHelper {
  ...
  static const String digitalPaymentFailedScreen =
      '/digital-payment-failed-screen';
  static const String airtime = '/airtime';
  static const String billPayment       = '/bill-payment';
  static const String billPaymentDetail = '/bill-payment-detail';
  ...
  static String getVerificationRoute(String? number, String? email,
    ...
    return '$verification?page=$page&number=$number&email=$email&token=$token&pass=$pass&login_type=$loginType&session=$authSession&user_model=$userModel&back_from_this=${backFromThis.toString()}&service_otp=$serviceOtp';
  }
  ...
  static String getResetPasswordRoute(
      ...
      '$resetPassword?phone=$phone&token=$token&page=$page&email=$email';
  ...
  static String getDigitalPaymentFailedScreen(String orderId,
      {bool? createAccount}) {
    return '$digitalPaymentFailedScreen?orderId=$orderId&create_account=$createAccount';
  }

  static String getAirtimeRoute() => airtime;
  static String getBillPaymentRoute() => billPayment;
  static String getBillPaymentDetailRoute() => billPaymentDetail;
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        ...
        page: () {
          ...
          return VerificationScreen(
            serviceOtp: Get.parameters['service_otp'] != 'null'
                ? Get.parameters['service_otp']
                : null,
    ...
    GetPage(
        ...
        page: () {
          ...
          int? createUserId = Get.parameters['create_user_id'] != null &&
    ...
    GetPage(
        ...
        page: () {
          ...
          if (Get.parameters['order-chat'] != 'null') {
            orderChat = OrderChatModel.fromJson(jsonDecode(utf8.decode(base64Url
                .decode(Get.parameters['order-chat']!.replaceAll(' ', '+')))));
          }
          User? user;
    ...
    GetPage(
        name: digitalPaymentFailedScreen,
        page: () {
          return DigitalPaymentFailedScreen(
    ...
    GetPage(
        ...
        page: () {
          ...
          return const AirtimeScreenStepper();
        }),
    GetPage(
        name: billPayment,
        page: () {
          Get.lazyPut(() => BillPaymentController());
          return getRoute(const BillPaymentScreen());
        }),
    GetPage(
        name: billPaymentDetail,
        page: () {
          final BillPaymentRecord record = Get.arguments as BillPaymentRecord;
          return BillPaymentDetailScreen(initialRecord: record);
        }),
  ];
  ...
  static Widget getRoute(Widget navigateTo,
    ...
    if (GetPlatform.isAndroid) {
      minimumVersion =
          Get.find<SplashController>().configModel?.appMinimumVersionAndroid ?? 0.0;
    } else if (GetPlatform.isIOS) {
      minimumVersion =
          Get.find<SplashController>().configModel?.appMinimumVersionIos ?? 0.0;
    }

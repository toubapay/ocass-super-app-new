...
class ItemRepository implements ItemRepositoryInterface {
  ...
  Future getList2({
    ...
    if (isPopularItem) {
      return await _getModuleWiseItems(
          type: type!,
          moduleId: moduleId!,
          source: source ?? DataSourceEnum.client,
          offset: offset!,
  ...
  Future<ItemModel?> _getPopularItemList(
    ...
    String uri = Uri.parse(AppConstants.popularItemUri)
  ...
  Future<ItemModel?> _getModuleWiseItems(
      {required String type,
    ...
    headers.addAll({AppConstants.moduleId: moduleId});
  ...
  Future<ItemModel?> _getReviewedItemList(
    ...
    String uri = Uri.parse(AppConstants.reviewedItemUri)
        .replace(queryParameters: query)
        .toString();
  ...
  Future<ItemModel?> _getDiscountedItemList(
    ...
    String cacheId =
        '${AppConstants.discountedItemsUri}?type=$type&offset=1&limit=50${Get.find<SplashController>().module != null ? Get.find<SplashController>().module!.id! : '1'}';
    ...
    String uri = Uri.parse(AppConstants.discountedItemsUri)
        .replace(queryParameters: query)
        .toString();

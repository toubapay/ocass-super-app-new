                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Align(
                                  ...
                                  child: Container(
                                    height: 89,
                                    // color: Theme.of(context).cardColor.withValues(alpha: scrollingRate == 0.0 ? 1 : 0),
                                    padding: EdgeInsets.only(
                                      left: Get.find<
                                          LocalizationController>()
                                          .isLtr
                                                  ...
                                                  Expanded(
                                                      child: Text(
                                                        ...
                                                        style: robotoMedium.copyWith(
                                                          fontSize: Dimensions.fontSizeLarge - (scrollingRate * 3),
                                                          color: Color.lerp(
                                                            Colors.white,

    ...
    return GetBuilder<StoreController>(builder: (storeController) {
      return Scaffold(
        appBar: CustomAppBar(
          ...
          onVegFilterTap: widget.isRecommendedStore
              ? null
              : (String type) {
                  if (widget.isPopular) {
          ...
          child: SingleChildScrollView(
            ...
            child: FooterView(
              child: Column(children: [
                widget.isTopOfferStore && ResponsiveHelper.isDesktop(context)
                    ? Container(
                        height: 64,
                                ...
                                child: Row(children: [
                                  ...
                                  PopupMenuButton(
                                    ...
                                    onSelected: (dynamic value) =>
                                        storeController.setTopOfferSort(value),
                                  ),
                                  const SizedBox(

                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  onTap: () async {
                                    await Get.find<ParcelController>()
                                        .getParcelCategoryList();
                                  },
                                  child: Text('what_would_you_like_to_send'.tr,
                                        ...
                                        ? CarouselSlider.builder(
                                            ...
                                            itemBuilder:
                                              ...
                                              return ClipRRect(
                                                ...
                                                child: CustomImage(
                                                  image:
                                                      '${bannerController.parcelOtherBannerModel!.banners![index].imageFullUrl}',
                                                ),
                                              );
                                            },
                                          )
                              ...
                              Padding(
                                padding: EdgeInsets.symmetric(
                                    horizontal: isDesktop
                                        ? 0
                                        : Dimensions.paddingSizeLarge),
                                child: Text('experience_the_best_with_us'.tr,
                                    style: robotoBold.copyWith(
                                        fontSize: Dimensions.fontSizeLarge)),
                              ),
                              const SizedBox(
                              ...
                              Padding(
                                padding: EdgeInsets.symmetric(
                                    horizontal: isDesktop
                                        ? 0
                                        : Dimensions.paddingSizeLarge),
                                child: parcelController.videoContentDetails !=
                                        null
                                    ? isDesktop
                                        ? Row(
                                            crossAxisAlignment:
                                                        ...
                                                        child: parcelController
                                                            ...
                                                            : parcelController
                                                                ...
                                                                ? GetServiceVideoWidget(
                                                                    youtubeVideoUrl:
                                                                        parcelController.videoContentDetails!.bannerVideo ??
                                                                            '',
                                                                    fileVideoUrl:
                                                                        '',
                                                                  )
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        return DeliverItemCardWidget(
          ...
          description: parcelController
              .whyChooseDetails!.banners![index].shortDescription!,
        );
      },
    );
  }

  Widget mobileExperienceView(
      bool isDesktop, ParcelController parcelController) {
    return Container(
      height: 80,
            ...
            return Container(
              ...
              child: DeliverItemCardWidget(
                image:
                    '${parcelController.whyChooseDetails!.banners![index].imageFullUrl}',
                itemName:
                    parcelController.whyChooseDetails!.banners![index].title!,
                description: parcelController
                    .whyChooseDetails!.banners![index].shortDescription!,
              ),
            );

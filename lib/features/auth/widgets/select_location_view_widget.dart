...
class _SelectLocationViewWidgetState extends State<SelectLocationViewWidget> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<StoreRegistrationController>(
      ...
      bool isRentalModule = widget.fromView &&
      ...
      if (storeRegController.zoneList != null &&
          storeRegController.zoneIds != null) {
        for (int index = 0;
                        ...
                        children: [
                            ...
                            widget.fromView
                                ? ZoneSelectionWidget(
                                    ...
                                    zoneList: zoneList,
                                    callBack: () {
                                      _setPolygon(storeRegController.zoneList![
                                          storeRegController
                                              .selectedZoneIndex!]);
                                    })
                                : const SizedBox(),
          ...
          ? Expanded(
              ...
              children: [
                ZoneSelectionWidget(
                    ...
                    zoneList: zoneList,
                    callBack: () {
                      _setPolygon(storeRegController
            ...
            child: Container(
              ...
              child: ClipRRect(
                ...
                child: Stack(clipBehavior: Clip.none, children: [
                  ...
                  const Center(
                      child: CustomAssetImageWidget(Images.markerStore,
                          height: 40, width: 40)),
                  Positioned(
                    ...
                    child: InkWell(
                      onTap: () async {
                        var p = await Get.dialog(LocationSearchDialogWidget(
                  ...
                  !widget.fromView
                      ? Positioned(
                          ...
                          child: CustomButton(
                            buttonText: storeRegController.inZone
                                ? 'set_location'.tr
                                : 'not_in_zone'.tr,

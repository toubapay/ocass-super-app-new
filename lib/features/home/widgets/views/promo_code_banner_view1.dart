...
class PromoCodeBannerView1 extends StatefulWidget {
  const PromoCodeBannerView1({super.key});

  @override
  State<PromoCodeBannerView1> createState() => _PromoCodeBannerViewState();
}

class _PromoCodeBannerViewState extends State<PromoCodeBannerView1> {
          ...
          CarouselSlider.builder(
            ...
            itemBuilder: (BuildContext context, int itemIndex, int pageViewIndex) {
              return Container(
                ...
                child: Row(children: [
                  Expanded(
                    child: Image.asset(Images.couponOfferIcon, height: 82, width: 115),
                  ),

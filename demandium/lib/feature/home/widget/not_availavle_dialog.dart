...
class ServiceNotAvailableDialog extends StatefulWidget {
  ...
  const ServiceNotAvailableDialog({
    super.key,
    this.address,
    this.forCard = false,
  ...
  @override
  State<ServiceNotAvailableDialog> createState() =>
      _ServiceNotAvailableDialogState();
}
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              widget.forCard
                  ? 'services_from_your_cart_is_not'.tr
                  : "there_are_no_services".tr,

...
class HighlightProviderWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<ServiceAdvertisementController>(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              'see_our_most_popular_providers_and_service'.tr,
                          ...
                          CarouselSlider.builder(
                            options: CarouselOptions(
                              ...
                              onPageChanged: (index, reason) {
                                advertisementController.setCurrentIndex(
                                  index,
                                  true,
                                );
    ...
    return GetBuilder<ServiceAdvertisementController>(
      builder: (advertisementController) {
        return advertisementController.advertisementList != null &&
            ...
            ? Expanded(
                child: Container(
                  ...
                  margin: EdgeInsets.only(
                    top: Dimensions.paddingSizeLarge * 1.5,
                              ...
                              options: CarouselOptions(
                                ...
                                onPageChanged: (index, reason) {
                                  if (advertisementController
                                      ...
                                      "video_promotion") {
                                    advertisementController
                                        .updateAutoPlayStatus(status: false);
                                  } else {
                                    advertisementController
                                        .updateAutoPlayStatus(status: true);
                                  }
                                  advertisementController.setCurrentIndex(
                                    index,
                                    true,
            ...
            : advertisementController.advertisementList == null
            ? const Expanded(child: Center(child: AdvertisementShimmer()))
            : const SizedBox();
      },
    );
  }
...
class AdvertisementVideoPromotionWidget extends StatefulWidget {
  ...
  @override
  State<AdvertisementVideoPromotionWidget> createState() =>
      _AdvertisementVideoPromotionWidgetState();
}

class _AdvertisementVideoPromotionWidgetState
    extends State<AdvertisementVideoPromotionWidget> {
  ...
  void initState() {
    ...
    videoPlayerController.addListener(() {
      if (videoPlayerController.value.duration ==
        ...
        Get.find<ServiceAdvertisementController>().updateAutoPlayStatus(
          status: true,
          shouldUpdate: true,
        );
      }
  ...
  Future<void> initializePlayer() async {
    videoPlayerController = VideoPlayerController.networkUrl(
      Uri.parse(widget.advertisement.promotionalVideoFullPath ?? ""),
    );
                          ...
                          gradient: LinearGradient(
                            colors: [
                              Get.isDarkMode
                                  ...
                                  : Colors.white, // Color at the beginning
                              Get.isDarkMode
                                  ? Theme.of(context).cardColor
                                  : Colors.cyan.shade50, // Color in the middle
                              Get.isDarkMode
              ...
              children: [
                Row(
                  children: [
                    ...
                    InkWell(
                      onTap: () => Get.toNamed(
                        ServiceRouteHelper.getProviderDetails(
                          widget.advertisement.providerId!,
                        ),
                      ),
                      child: Container(
...
class AdvertisementProfilePromotionWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GetBuilder<ServiceAdvertisementController>(
        builder: (advertisementController) {
          return InkWell(
            onTap: () => Get.toNamed(
              ServiceRouteHelper.getProviderDetails(advertisement.providerId!),
            ),
            child: Stack(
              children: [
                Column(
                      ...
                      child: Row(
                        children: [
                          ClipRRect(
                            ...
                            child: CustomImage(
                              image:
                                  advertisement.providerProfileImageFullPath ??
                                  "",
                              height: 60,
                              width: 60,
                            ),
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      '${advertisement.providerData?.ratingCount} ${'reviews'.tr}',
                                      style: robotoRegular.copyWith(
                                        color: Theme.of(context).hintColor,
                                        fontSize: Dimensions.fontSizeSmall,
                                      ),
        ...
        return advertisementController.advertisementList != null &&
            ...
            ? Row(
                ...
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: advertisementController.advertisementList!.map((
                      advertisement,
                    ) {

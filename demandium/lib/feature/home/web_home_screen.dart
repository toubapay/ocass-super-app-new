...
class WebHomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.find<ServiceBannerController>().setCurrentIndex(0, false);
                        ...
                        builder: (providerController) {
                          return GetBuilder<ServiceController>(
                            builder: (serviceController) {
                              ...
                              int? biddingStatus =
                                  configModel.content?.biddingStatus;
                                  ...
                                  children: [
                                    ...
                                    (serviceController.allService != null &&
                                        ...
                                        ? TitleWidget(
                                            ...
                                            // onTap: () => Get.toNamed(ServiceRouteHelper.getSearchResultRoute()),
                                          )

...
class WebCampaignView extends GetView<ServiceBannerController> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<ServiceCampaignController>(
      builder: (campaignController) {
        if (campaignController.campaignList != null &&
            campaignController.campaignList!.isEmpty) {
                        ...
                        ? InkWell(
                            onTap: () {
                              ...
                              campaignController.navigateFromCampaign(
                                campaignController.campaignList![0].id!,
                                campaignController
                                    .campaignList![0]
                                    .discount!
                                    .discountType!,
                            ...
                            child: ClipRRect(
                              ...
                              child: CustomImage(
                                image:
                                    '${campaignController.campaignList![0].coverImageFullPath}',
                        ...
                        : Stack(
                            ...
                            children: [
                              PageView.builder(
                                      ...
                                      Expanded(
                                        child: InkWell(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: CustomImage(
                                              image:
                                                  '${campaignController.campaignList![index1].coverImageFullPath}',
                                              fit: BoxFit.cover,
                                              height: 220,
                                            ),
                                          ),
                                        ...
                                        child: hasSecond
                                            ? InkWell(
                                                ...
                                                child: ClipRRect(
                                                  ...
                                                  child: CustomImage(
                                                    image:
                                                        '${campaignController.campaignList![index2].coverImageFullPath}',
                                                    fit: BoxFit.cover,
                                                    height: 220,
                                                  ),
                                                ),
                                ...
                                onPageChanged: (int index) => campaignController

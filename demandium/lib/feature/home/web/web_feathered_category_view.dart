...
class WebFeatheredCategoryView extends StatefulWidget {
  ...
  @override
  State<WebFeatheredCategoryView> createState() =>
      _WebFeatheredCategoryViewState();
}
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ServiceController>(
      builder: (serviceController) {
        return serviceController.categoryList != null
            ? SizedBox(
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      onTap: () {
                                        Get.toNamed(
                                          ServiceRouteHelper.getFeatheredCategoryService(
                                            serviceController
                                                    .categoryList?[categoryIndex]
                                                    .name ??
                                                "",

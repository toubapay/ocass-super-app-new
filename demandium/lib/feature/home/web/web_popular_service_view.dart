        ...
        return GetBuilder<ServiceController>(
          builder: (serviceController) {
            if (serviceController.popularServiceList != null &&
                serviceController.popularServiceList!.isEmpty) {
              ...
              if (serviceController.popularServiceList != null) {
                ...
                if ((advertisementController.advertisementList != null &&
                  ...
                  length = serviceController.popularServiceList!.length > 6
                      ? 6
                      : serviceController.popularServiceList!.length;
                  itemCount = 3;
                } else {
                  itemCount = 5;
                  length = serviceController.popularServiceList!.length > 10
                      ? 10
                      : serviceController.popularServiceList!.length;
                }
                    ...
                    GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return ServiceWidgetVertical(
                          service: serviceController.popularServiceList![index],
                          fromType: '',
                ...
                if (advertisementController.advertisementList == null) {
                  length = 6;
                  itemCount = 3;
                } else if (advertisementController.advertisementList != null &&
                    advertisementController.advertisementList!.isEmpty) {
                  length = 10;
                  itemCount = 5;
                }
                return Padding(

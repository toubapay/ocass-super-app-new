                                    ...
                                    .map(
                                      (item) => GestureDetector(
                                        onTap: () => SharePlus.instance.share(
                                          ShareParams(
                                            uri: Uri.tryParse(
                                              '${AppConstants.websiteUrl}${ServiceRouteHelper.signUp}?referral_code=${Get.find<UserController>().userInfoModel?.referCode ?? ""}',
                                            ),
                                            subject:
                                                Get.find<
                                                        ...
                                                        ?.appUrlAndroid !=
                                                    null
                                                ? '${AppConstants.appName} ${'referral_code'.tr}: ${Get.find<UserController>().userInfoModel?.referCode ?? ""} \n${'download_app_from_this_link'.tr}: ${Get.find<ServiceSplashController>().configModel.content?.appUrlAndroid}'
                                                : '${AppConstants.appName} ${'referral_code'.tr}: ${Get.find<UserController>().userInfoModel?.referCode ?? ""}',
                                          ),
                                        ),
                                        child: Container(

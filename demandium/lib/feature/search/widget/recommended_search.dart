      ...
      builder: (serviceController) {
        return Column(
          ...
          children: [
            Row(
              ...
              children: [
                ...
                serviceController.recommendedSearchList != null &&
                        serviceController.recommendedSearchList!.isEmpty
                    ? const SizedBox()
                    : InkWell(
                        onTap: () =>
                            serviceController.recommendedSearchList == null
            ...
            (serviceController.recommendedSearchList != null &&
                    serviceController.recommendedSearchList!.isNotEmpty)
                ? Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: ListView.builder(
                                  ...
                                  onTap: () {
                                    ...
                                    Get.toNamed(
                                      ServiceRouteHelper.getSearchResultRoute(
                                        queryText:
                                            serviceController
                                                .recommendedSearchList?[index]
                                                .name ??
                                            '',
                                      ),
                                    );
                                    Get.find<AllSearchController>()
                                        .populatedSearchController(
                                          serviceController
                                                  .recommendedSearchList?[index]
                                                  .name ??
                                              '',
                        ...
                        itemCount:
                            serviceController.recommendedSearchList!.length,
                      ),
                    ),
                  )
                : serviceController.recommendedSearchList != null &&

    ...
    return Dialog(
      ...
      child: GetBuilder<BookingDetailsController>(
        builder: (bookingDetailsController) {
          List<RepeatHistory> editHistory =
              ...
              children: [
                SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      const SizedBox(
                        height: Dimensions.paddingSizeDefault * 2.5,
                      ),
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          List<RepeatHistoryLog> historyLogs =
                              editHistory[index].repeatHistoryLogs ?? [];
                          double subTotal = 0;
                          ...
                          return RepeatBookingHistoryExpansionTile(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            textWidget(
                                              text:
                                                  "# ${editHistory[index].readableId ?? ""}",
                                              textStyle: robotoRegular,
                                            ),
                                            textWidget(
                                              text: DateConverter.dateMonthYearTime(
                                                DateConverter.isoUtcStringToLocalDate(
                                                  editHistory[index].createdAt!,
                                                ),
                                              ).tr,
                                            ),
                                          ],
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        textWidget(
                                          text:
                                              "${editHistory[index].oldQuantity ?? ""} → ${editHistory[index].newQuantity ?? ""}"
                                                  .tr,
                                        ...
                                        textWidget(
                                          text:
                                              editHistory[index].isMultiple == 1
                                              ? "edited_multiple_booking".tr
                                              : "edited_only_this_single_booking"
                                                    .tr
                                                    .tr,
                                        ),
                                      ],
                            ...
                            children: [
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            Text(
                                              "${historyLogs[index].quantity ?? 1} x ${PriceConverter.convertPrice(historyLogs[index].serviceCost ?? 0)}",
                                              style: robotoRegular.copyWith(
                                                fontSize:
                                                    Dimensions.fontSizeSmall,
                                              ),
                              ...
                              _SubTotalItemWidget(
                                ...
                                additionalSign: "-",
                                amount:
                                    editHistory[index].totalDiscountAmount ?? 0,
                                boldText: false,
                              ),
                              const SizedBox(
                                height: Dimensions.paddingSizeTine,
                              ...
                              //   title: Get.find<ServiceSplashController>().configModel.content?.additionalChargeLabelName?.tr ?? "",
                              //   additionalSign: "+",

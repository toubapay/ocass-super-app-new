  ...
  Widget build(BuildContext context) {
    return Timeline.tileBuilder(
      ...
      padding: EdgeInsets.symmetric(
        vertical: 20.0,
        horizontal: Get.find<ServiceLocalizationController>().isLtr ? 0 : 10,
      ),
          ...
          return Padding(
            ...
            child: index == 0
                ? Column(
                    ...
                    children: [
                      Text(
                        "${'service_booked_by_customer'.tr} ${bookingDetailsContent?.customer?.firstName ?? bookingDetailsContent?.serviceAddress?.contactPersonName ?? ""} "
                ...
                ? Column(
                    ...
                    children: [
                      ...
                      Text(
                        DateConverter.dateMonthYearTimeTwentyFourFormat(
                          DateConverter.isoUtcStringToLocalDate(
                            statusHistories![index - 1].createdAt!,
                          ),
                        ),
                        style: robotoRegular.copyWith(
                          fontSize: Dimensions.fontSizeSmall,
                        ...
                        child: ListView.builder(
                          itemBuilder: (_, index) {
                            return Column(
                              ...
                              children: [
                                Text(
                                  "${'schedule_changed_by'.tr} ${scheduleHistories![index + 1].user!.userType.toString().tr}",
                                  style: robotoRegular.copyWith(
                                    fontSize: Dimensions.fontSizeDefault,
                                  ),
                                ),
                                ...
                                Text(
                                  DateConverter.dateMonthYearTimeTwentyFourFormat(
                                    DateTime.tryParse(
                                      scheduleHistories![index + 1].schedule!,
                                    )!,
                                  ),
                                  style: robotoRegular.copyWith(
                                    fontSize: Dimensions.fontSizeSmall,

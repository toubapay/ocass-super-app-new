...
class LocationRepo {
  ...
  Future<Response> getAllAddress() async {
    return await apiClient.getData(
      "${AppConstants.addressUri}?limit=100&offset=1&guest_id=${Get.find<ServiceSplashController>().getGuestId()}",
    );
  }
  ...
  Future<Response> addAddress(AddressModel addressModel) async {
    return await apiClient.postData(
      "${AppConstants.addressUri}?guest_id=${Get.find<ServiceSplashController>().getGuestId()}",
      addressModel.toJson(),
    );
  }
  ...
  Future<Response> updateAddress(
    ...
    return await apiClient.putData(
      '${AppConstants.addressUri}/$addressId?guest_id=${Get.find<ServiceSplashController>().getGuestId()}',
      addressModel.toJson(),
    );
  }

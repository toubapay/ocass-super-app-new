                              ...
                              child: GetBuilder<CreatePostController>(
                                initState: (_) {
                                  Get.find<CreatePostController>()
                                      .getMyPostList(1, reload: true);
                                },
                                builder: (createPostController) {
                                  return (!createPostController.isLoading &&
                                      ...
                                      ? GridView.builder(
                                          ...
                                          itemBuilder: (BuildContext context, index) {
                                            return Padding(
                                              ...
                                              child: const SubCategoryShimmer(
                                                isEnabled: true,
                                                hasDivider: false,
                                              ),
                                            );

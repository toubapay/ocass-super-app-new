    ...
    return GetBuilder<MyFavoriteController>(
      builder: (myFavoriteController) {
        return RefreshIndicator(
          ...
          child:
              myFavoriteController.providerList != null &&
                  myFavoriteController.providerList!.isNotEmpty
              ? PaginatedListView(
                  scrollController: scrollController,
                  totalSize: myFavoriteController.providerModel?.content?.total,
                  offset:
                      myFavoriteController.providerModel?.content?.currentPage,
                  onPaginate: (int offset) async =>
                      await myFavoriteController.getProviderList(offset, false),
                  ...
                  itemView: Expanded(
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return FavoriteProviderItemView(
                          providerData:
                              myFavoriteController.providerList![index],
                          index: index,
                        );
                      },
                      shrinkWrap: true,
              ...
              : myFavoriteController.providerList != null &&
                    myFavoriteController.providerList!.isEmpty
              ? Padding(
                  padding: EdgeInsets.only(bottom: Get.height * 0.15),
                  child: const NoDataScreen(
                    text: "you_have_not_any_favorite_provider",

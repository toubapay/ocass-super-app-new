...
class FavoriteProviderItemView extends StatelessWidget {
  ...
  final int index;
  const FavoriteProviderItemView({
    super.key,
    required this.providerData,
    required this.index,
    this.enableSlideDelete = true,
  });
            ...
            CustomSlidableAction(
              ...
              onPressed: (context) async {
                showModalBottomSheet(
                  ...
                  builder: (context) =>
                      FavoriteItemRemoveDialog(providerId: providerData.id),
            ...
            children: [
              ...
              Positioned.fill(
                child: RippleButton(
                  onTap: () {
                    Get.toNamed(
                      ServiceRouteHelper.getProviderDetails(providerData.id!),
                    );
                  },
                ),
              ),

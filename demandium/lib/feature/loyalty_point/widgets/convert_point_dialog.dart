          ...
          child: GetBuilder<LoyaltyPointController>(builder: (loyaltyPointController){
            return Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              Center(child: Padding(padding: const EdgeInsets.all(8.0),
                child: Text("enter_point_amount".tr,style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge),),
              )),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    boxShadow: [BoxShadow(color: Theme.of(context).hintColor.withValues(alpha: .12), blurRadius: 1,
                        spreadRadius: 1, offset: const Offset(0,0))]
                ),
                child: Column(
                  children: [
                    Text('convert_point_to_wallet_money'.tr, style: robotoMedium.copyWith(color:Get.isDarkMode?Colors.white70 :  Theme.of(context).primaryColor,fontSize: Dimensions.fontSizeLarge),),
                    Padding(
                      padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
                      child: SizedBox(height: 50,child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle: robotoRegular.copyWith(color: Theme.of(context).hintColor.withValues(alpha: .5)),
                    ...
                    Row(children: [
                      Text('${'available_point'.tr} '
                          ,style: robotoRegular.copyWith(color:Get.isDarkMode?Colors.white70 :  Theme.of(context).primaryColor,fontSize: Dimensions.fontSizeDefault),
                        ),
                      Directionality(
              ...
              Container(decoration: BoxDecoration(color: Theme.of(context).primaryColor.withValues(alpha: 0.1),
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
                  Padding(
                      ...
                      child: Text('note'.tr,style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge,color: Get.isDarkMode?Colors.white70 : Theme.of(context).primaryColor),)),

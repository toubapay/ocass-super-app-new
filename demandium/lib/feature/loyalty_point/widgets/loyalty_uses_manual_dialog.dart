...
class LoyaltyPointUsesManualDialog extends StatelessWidget {
  const LoyaltyPointUsesManualDialog({super.key}) ;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                          ...
                          child: Text('how_to_use'.tr,style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge,color:Get.isDarkMode?Colors.white70 : Theme.of(context).primaryColor),)),

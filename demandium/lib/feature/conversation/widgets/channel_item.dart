...
class ChannelItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (channelData.channelUsers != null &&
        channelData.channelUsers!.length > 1) {
      conversationUser =
          channelData.channelUsers?[0].user?.userType != "customer"
          ? channelData.channelUsers![0]
          : channelData.channelUsers![1];
      isRead = channelData.channelUsers![0].user?.userType == "customer"
          ? channelData.channelUsers![0].isRead!
          : channelData.channelUsers![1].isRead!;
      isSeen = channelData.channelUsers?[0].user?.userType == "customer"
          ? channelData.channelUsers![1].isRead
          : channelData.channelUsers![0].isRead;
    }
        ...
        ? Container(
            ...
            decoration: BoxDecoration(
              ...
              color: isRead == 0
                  ...
                  : Theme.of(
                      context,
                    ).cardColor.withValues(alpha: Get.isDarkMode ? 0.5 : 1),
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                          ...
                                          child: Text(
                                            isAdmin
                                                ...
                                                : conversationUser
                                                          ...
                                                          ?.userType ==
                                                      'provider-admin'
                                                ? "${conversationUser.user?.provider?.companyName}"
                                        ...
                                        if (conversationUser.user?.userType ==
                                            "super-admin")
                                          Container(
                                            decoration: BoxDecoration(
                                              color: Theme.of(context)
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            channelData.lastMessageSentUser ==
                                                    userName
                                                ? Icon(
                                                    Icons.done_all,
                                                    color:

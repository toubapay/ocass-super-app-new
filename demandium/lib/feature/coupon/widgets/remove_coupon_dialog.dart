...
class _ProductBottomSheetState extends State<RemoveCouponWidget> {
  ...
  Padding pointerInterceptor() {
    return Padding(
      ...
      child: PointerInterceptor(
        child: GetBuilder<ServiceCouponController>(
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Image.asset(
                    widget.isReplace
                        ? Images.replaceCoupon
                        : Images.couponWarning,
                  ...
                  Text(
                    widget.isReplace
                        ? "want_to_replace_existing_coupon".tr
                        : "want_to_remove_coupon".tr,
                  ...
                  Padding(
                    ...
                    child: Text(
                      widget.isReplace
                          ? "new_coupon_use_text".tr
                          : "remove_coupon_text".tr,
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: CustomButton(
                            buttonText: widget.isReplace
                                ? 'yes_continue'.tr
                                : "yes_remove".tr,
                            backgroundColor: Theme.of(context).primaryColor,
                            isLoading: serviceCouponController.isLoading,
                            onPressed: widget.isReplace
                                ? () async {
                                    serviceCouponController
                                        .updateSelectedCouponIndex(index: -1);
                                      ...
                                      if (Get.find<ServiceCartController>()
                                        ...
                                        if (addCoupon) {
                                          ...
                                          customCouponSnackBar(
                                            "can_not_apply_coupon",
                                            subtitle:
                                                "${'valid_for_minimum_booking_amount_of'.tr} ${PriceConverter.convertPrice(widget.couponModel.discount?.minPurchase ?? 0)} ",
                                          );
                                        }
                                      } else {
                                        Get.back();
                                ...
                                : () async {
                                    await serviceCouponController.removeCoupon(
                                      index: widget.index,
                                    );
                                  },

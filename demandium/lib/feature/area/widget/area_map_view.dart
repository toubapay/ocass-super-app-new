...
class _AreaMapViewScreenState extends State<AreaMapViewScreen> {
  ...
  void initState() {
    ...
    for (int index = 0; index < widget.zoneList.length; index++) {
      globalKeyMap.addAll({index.toString(): GlobalKey()});
    }
  }
                ...
                children: [
                  ListView.builder(
                    itemBuilder: (context, index) {
                      return MyMarker(
                        globalKeyMap[index.toString()]!,
                        zone: widget.zoneList[index],
                      );
                    },
                    ...
                    child: GoogleMap(
                      ...
                      onMapCreated: (GoogleMapController mapController) {
                        ...
                        serviceAreaController
                            .setMarker(widget.zoneList, globalKeyMap)
                            .then(
                              (value) =>
                                  serviceAreaController.mapBound(mapController),
                            );
                      },

...
class _SuggestServiceScreenState extends State<SuggestServiceScreen> {
  ...
  void initState() {
    super.initState();
    Get.find<ServiceCategoryController>().getCategoryList(false);
  }
                            ...
                            Padding(
                              ...
                              child: Align(
                                ...
                                child: GestureDetector(
                                  onTap: () => Get.toNamed(
                                    ServiceRouteHelper.getNewSuggestedServiceList(),
                                  ),
                                  child: Container(
                          ...
                          Column(
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  'tell_us_more_about_your_service'.tr,
                                  style: robotoMedium.copyWith(
                                    fontSize: Dimensions.fontSizeDefault,
                              ...
                              Padding(
                                ...
                                child: Text(
                                  'suggest_more_service_that_you_willing'.tr,
                              ...
                              AnimatedContainer(
                                ...
                                child: Padding(
                                  ...
                                  child: Image.asset(
                                    ...
                                    width: suggestServiceController
                                        .initialImageSize,
                                  ),
                                ),
                              ),
                              ...
                              AnimatedOpacity(
                                opacity: suggestServiceController
                                    .initialContainerOpacity,
                          ...
                          AnimatedPositioned(
                            ...
                            child: suggestServiceController.isLoading == false
                                ? CustomButton(
                                    ...
                                    fontSize: Dimensions.fontSizeDefault,
                                    buttonText:
                                        suggestServiceController
                                            .isShowInputField
                                        ? "send_request".tr
                                        : 'request_for_service'.tr,
                                    onPressed: () {
                                      if (!suggestServiceController
                                          .isShowInputField) {
                                        suggestServiceController
                                        ...
                                        } else if (suggestServiceController
                                                .serviceNameController
                                                .text ==
                                            "") {
                                          customSnackBar(
                                            'provide_your_desired_service_name'
                                                .tr,
                                            type: ToasterMessageType.info,
                                          );
                                        } else if (suggestServiceController
                                            ...
                                            .isEmpty) {
                                          customSnackBar(
                                            "provide_some_details_about_your_service"
                                                .tr,
                                            type: ToasterMessageType.info,
                                          );
                                        } else {

...
class AvailableProviderWidget extends StatefulWidget {
  ...
  const AvailableProviderWidget({
    super.key,
    required this.subcategoryId,
    this.showUnavailableError = false,
  });
  @override
...
class _ProductBottomSheetState extends State<AvailableProviderWidget> {
  ...
  void initState() {
    super.initState();
    Get.find<ServiceCartController>().getProviderBasedOnSubcategory(
    ...
    return GetBuilder<ServiceCartController>(
      builder: (cartController) {
        ...
        return Padding(
          ...
          child: PointerInterceptor(
            child: Container(
              width: ResponsiveHelper.isDesktop(context) && providerList != null
                  ? Dimensions.webMaxWidth / 2
                  : ResponsiveHelper.isDesktop(context) && providerList == null
                  ? 120
              ...
              child: providerList != null
                  ? Column(
                      ...
                      children: [
                                    ...
                                    children: [
                                      ...
                                      ListView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          return ProviderCartItemView(
                                            providerData: providerList[index],
                                            index: index,
                                          );
                                        },
                                      ),
                        ...
                        cartController.checkProviderUnavailability()
                            ? Padding(
                                padding: const EdgeInsets.only(
                                  bottom: Dimensions.paddingSizeSmall,
                                ),
                                child: Text(
                                  "* ${"your_selected_provider_is_unavailable_right_now".tr} ${'or'.tr} ${'let'.tr} ${AppConstants.appName} ${'choose_for_you'.tr}",
                                  style: robotoRegular.copyWith(
                        ...
                        CustomButton(
                          ...
                          onPressed: () async {
                            await cartController.updateProvider(
                              cartController.selectedProviderIndex != -1
                                  ? cartController.providerList![cartController
                                        .selectedProviderIndex]
                                  : null,
                            );
                            Get.back();

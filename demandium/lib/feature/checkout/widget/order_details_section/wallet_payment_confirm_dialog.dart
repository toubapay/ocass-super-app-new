...
class WalletPaymentConfirmDialog extends StatelessWidget {
  const WalletPaymentConfirmDialog({super.key});
  @override
  Widget build(BuildContext context) {
    return GetBuilder<ServiceCartController>(
      builder: (cartController) {
        double walletBalance = cartController.walletBalance;
        double bookingAmount = Get.find<ServiceCartController>().totalPrice;
                    ...
                    children: <TextSpan>[
                      ...
                      TextSpan(
                        text: isPartialPayment
                            ...
                            : "want_to_pay_via_your_wallet".tr,
                ...
                isPartialPayment
                    ...
                    : Row(
                        ...
                        children: [
                          ...
                          Text(
                            PriceConverter.convertPrice(bookingAmount),
                            style: robotoBold.copyWith(
                              fontSize: Dimensions.fontSizeExtraLarge,
                              color: Theme.of(context).primaryColor,
                            ),

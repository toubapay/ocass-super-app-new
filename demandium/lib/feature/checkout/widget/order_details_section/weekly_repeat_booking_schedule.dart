      ...
      builder: (cartController) {
        return GetBuilder<ScheduleController>(
          builder: (scheduleController) {
            List<String> weeklyPickedDays = scheduleController
                .getWeeklyPickedDays();

            int scheduleDays =
                CheckoutHelper.calculateDaysCountBetweenDateRangeWithSpecificSelectedDay(
    ...
    if (scheduleController.getInitialWeeklyPickedDays().isEmpty) {
      ...
      customSnackBar(
        ...
        showDefaultSnackBar: false,
            ...
            null &&
        CheckoutHelper.calculateDaysCountBetweenDateRangeWithSpecificSelectedDay(
              scheduleController.initialPickedWeeklyRepeatBookingDateRange,
              scheduleController.getInitialWeeklyPickedDays(),
            ) <=
            0) {
      customSnackBar(
        "no_scheduled_days_available_inside_picked_date_range".tr,
        type: ToasterMessageType.info,
        showDefaultSnackBar: false,
      );
    } else {

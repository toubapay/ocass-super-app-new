...
class ProviderWithdrawBidDialog extends StatefulWidget {
  ...
  @override
  State<ProviderWithdrawBidDialog> createState() =>
      _ProviderWithdrawBidDialogState();
}
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "services_request_has_been_withdrawn".tr,
            ...
            Padding(
              ...
              child: Text(
                'you_can_not_processed_to_checkout_custom_booking_because'.tr,

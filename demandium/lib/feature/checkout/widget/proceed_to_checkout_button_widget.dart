...
class _ProceedToCheckoutButtonWidgetState
      ...
      builder: (scheduleController) {
        return GetBuilder<ServiceCartController>(
          builder: (cartController) {
            String? errorText = cartController
                                  ...
                                  if (Get.find<ServiceCartController>()
                                    ...
                                    Get.offAllNamed(
                                      ServiceRouteHelper.getMainRoute('home'),
                                          ...
                                          .cartList
                                          .isNotEmpty &&
                                      cartController.cartList.first.provider !=
                                          null &&
                                      (cartController
                                                  .cartList[0]
                                                  .provider
                                    ...
                                    if (schedule == null &&
                                        ...
                                        scheduleController.selectedServiceType ==
                                            ServiceType.regular) {
                                      customSnackBar(
                                        "select_your_preferable_booking_time"
                                            .tr,
                                        type: ToasterMessageType.info,
                                      );
                                        ...
                                        configModel
                                            ...
                                            1 &&
                                        scheduleController
                                                .checkValidityOfTimeRestriction(
                                                  Get.find<
                                    ...
                                    } else if (scheduleController.selectedServiceType ==
                                            ServiceType.repeat &&
                                        scheduleController
                                                .selectedRepeatBookingType ==
                                            RepeatBookingType.daily &&
                                        scheduleController
                                                .pickedDailyRepeatBookingDateRange ==
                                            null) {
                                      customSnackBar(
                                        "daily_select_time_and_date_hint".tr,
                                        type: ToasterMessageType.info,
                                      );
                                    } else if (scheduleController.selectedServiceType ==
                                            ServiceType.repeat &&
                                      ...
                                      customSnackBar(
                                        ...
                                        scheduleController
                                            ...
                                            .isEmpty) {
                                      customSnackBar(
                                        "weekly_select_time_and_date_hint".tr,
                                        type: ToasterMessageType.info,
                                      );
                                    } else if (scheduleController
                                                .selectedServiceType ==
                                    ...
                                    } else if ((addressModel.contactPersonName ==
                                                "null" ||
                                      ...
                                      customSnackBar(
                                        "please_input_new_account_password".tr,
                                        type: ToasterMessageType.info,
                                      );
                                    } else if (checkoutController.isCheckedCreateAccount &&
                                        checkoutController.confirmPasswordController.text.isEmpty) {
                                      customSnackBar(
                                        "please_input_confirm_password".tr,
                                        type: ToasterMessageType.info,
                                      );
                                    } else if (checkoutController.isCheckedCreateAccount &&
                                        ...
                                        checkoutController
                                            ...
                                            .then((value) {
                                              if (!value) {
                                                ...
                                                //   Get.toNamed(ServiceRouteHelper.getCheckoutRoute(
                                    ...
                                    if (scheduleController
                                      ...
                                      customSnackBar(
                                        "select_another_payment_method_to_pay_remaining_bill"
                                            .tr,
                                        type: ToasterMessageType.info,
                                      );
                                    } else if (checkoutController
                                      ...
                                      if (checkoutController
                                        ...
                                        checkoutController.placeBookingRequest(
                                          ...
                                          isPartial:
                                              ...
                                              : 0,
                                          address: addressModel!,
                                          offlinePaymentId: checkoutController
                                              .selectedOfflineMethod
                                              ?.id,
                                          selectedOfflinePaymentIndex:
                                              selectedOfflinePaymentIndex != -1
                                              ? selectedOfflinePaymentIndex
                                              : 0,
  ...
  void _makeDigitalPayment(
    ...
    String userId =
        ...
        Get.find<ServiceSplashController>().getGuestId();
    ...
    String serviceLocation =
        Get.find<ServiceLocationController>().selectedServiceLocationType.name;

    String addressId = (address?.id == "null" || address?.id == null)
        ? ""
        : address?.id ?? "";
    String zoneId =
        Get.find<ServiceLocationController>().getUserAddress()?.zoneId ?? "";
    String callbackUrl = GetPlatform.isWeb
        ? "$protocol//$hostname:$port$path"
        : AppConstants.baseUrl;
    int isPartial =
        Get.find<ServiceCartController>().walletPaymentStatus &&
            isPartialPayment
        ? 1
        : 0;

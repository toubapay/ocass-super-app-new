...
class _NearByFilterDialogState extends State<NearByFilterDialog> {
  ...
  void initState() {
    super.initState();
    Get.find<NearbyProviderController>().updatePopMenuStatus(
      true,
      shouldUpdate: false,
    );
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Wrap(
                            ...
                            spacing: 10,
                            runSpacing: 10,
                            children: nearbyProviderController.sortBy.map((
                              element,
                            ) {
                              return InkWell(
                                onTap: () => nearbyProviderController
                                    .updateSortBy(element),
                                child: Container(
                                ...
                                child: SizedBox(
                                  ...
                                  child: Padding(
                                    ...
                                    child: CustomCheckBox(
                                      ...
                                      value:
                                          nearbyProviderController
                                                  .providerAvailableStatus ==
                                              1
                                          ? true
                                          : false,
                                      onTap: () {
                                        nearbyProviderController
                                            .updateProviderAvailableStatus();
                                      },
                                    ),
                                  ),
                                ),
                          ...
                          ListView.builder(
                            itemBuilder: (context, index) {
                              return SizedBox(
                                ...
                                child: RadioGroup<String>(
                                  groupValue:
                                      nearbyProviderController.selectedRating,
                                  onChanged: (val) {
                                    if (val != null) {
                                      nearbyProviderController
                                          .updateFilterByRating(val);
                                    }
                                  },
                                  child: RadioListTile(
                                    ...
                                    value: nearbyProviderController
                                        .ratingFilter[index],
                                    controlAffinity:
                            ...
                            itemCount:
                                nearbyProviderController.ratingFilter.length,
                            shrinkWrap: true,
                      ...
                      Expanded(
                        child: CustomButton(
                          ...
                          onPressed: () async {
                            ...
                            await nearbyProviderController.getProviderList(
                              1,
                              true,
                              applyFilter: true,
                              initialPosition: widget.initialPosition,

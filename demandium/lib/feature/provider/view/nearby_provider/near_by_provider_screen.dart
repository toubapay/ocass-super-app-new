...
class _NearByProviderScreenState extends State<NearByProviderScreen>
  ...
  void initState() {
    ...
    _initialPosition = LatLng(
      double.tryParse(
            Get.find<ServiceLocationController>().getUserAddress()?.latitude ??
                "23.0000",
          ) ??
          23.0000,
      double.tryParse(
            Get.find<ServiceLocationController>().getUserAddress()?.longitude ??
                "90.0000",
          ) ??
          90.0000,
    );
  ...
  Future<void> _loadDart() async {
    await Get.find<ServiceCategoryController>().getCategoryList(false);
    Get.find<NearbyProviderController>().resetCategoryCheckedList(
      shouldUpdate: false,
    );
    ...
    return CustomPopWidget(
      child: Scaffold(
        appBar: CustomAppBar(
          ...
          actionWidget: GetBuilder<NearbyProviderController>(
                ...
                child: InkWell(
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      if (nearbyProviderController.isFilteredApplied())
                        Positioned(
                          top: -5,
                          right: -10,
                          child: Container(

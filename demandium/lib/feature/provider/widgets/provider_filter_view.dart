                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: ListView.builder(
                                ...
                                itemCount:
                                    providerBookingController.sortBy.length,
                                shrinkWrap: true,
                                itemBuilder: (context, index) {
                                  return InkWell(
                                    onTap: () => providerBookingController
                                        .updateSortByIndex(index),
                                    child: Container(
                                      padding: const EdgeInsets.symmetric(
                                    ...
                                    child: CustomCheckBox(
                                      title:
                                          categoryController
                                              ...
                                              .name ??
                                          "",
                                      value: providerBookingController
                                ...
                                Expanded(
                                  child: CustomButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      await providerBookingController

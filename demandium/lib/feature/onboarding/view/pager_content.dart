...
void _checkPermissionAndNavigate() async {
  Get.find<ServiceSplashController>().disableShowOnboardingScreen();
  ...
  if (permission == LocationPermission.denied ||
    ...
    Get.offAllNamed(
      ServiceRouteHelper.getPickMapRoute("", false, "", null, null),
    );
  } else {
    Get.dialog(const CustomLoader(), barrierDismissible: false);
    AddressModel address = await Get.find<ServiceLocationController>()
        .getCurrentLocation(true);
    ZoneResponseModel response = await Get.find<ServiceLocationController>()
        .getZone(address.latitude!, address.longitude!, false);

    if (response.isSuccess) {
      Get.find<ServiceLocationController>().saveAddressAndNavigate(
        address,
        false,
        '',
        false,

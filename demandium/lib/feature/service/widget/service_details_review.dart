  ...
  Widget build(BuildContext context) {
    return GetBuilder<ServiceTabController>(
      builder: (serviceTabController) {
        return serviceTabController.reviewList != null &&
                        ...
                        child: Column(
                          ...
                          children: [
                                    ...
                                    children: [
                                      Expanded(
                                        ...
                                        child: ReviewCardWidget(
                                          rating: serviceTabController.rating,
                                          transparent: true,
                                        ),
                                      ),
                            ...
                            PaginatedListView(
                              ...
                              totalSize: serviceTabController
                                  .reviewContent!
                                  .reviews!
                                  .total,
                              onPaginate: (int offset) async =>
                                  await Get.find<ServiceTabController>()
                                      .getServiceReview(
                                        widget.serviceID,
                                        offset,
                                        reload: false,
                                      ),
                              offset: serviceTabController
                                  .reviewContent!
                                  .reviews!
                                  .currentPage,
                              itemView: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return ServiceReviewItem(
                                    review:
                                        serviceTabController.reviewList![index],
                                ...
                                itemCount:
                                    serviceTabController.reviewList!.length,
                              ),
                            ),
                          ],
                        ),
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < rating.ratingGroupCount!.length; i++) {
      if (rating.ratingGroupCount![i].reviewRating == 1) {
        oneStar =
            (rating.ratingGroupCount![i].reviewRating! * rating.ratingCount!) /
            100;
    ...
    return Column(
      children: [
        ...
        _progressBar(title: 'good'.tr, percent: fourStar, total: totalFourStar),
        _progressBar(
          title: 'average'.tr,
          percent: threeStar,
        ...
        _progressBar(title: 'poor'.tr, percent: oneStar, total: totalOneStar),
      ],
    );
  }
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            rating.averageRating?.toStringAsFixed(2) ?? "0.0",
          ...
          RatingBar(
            rating: double.tryParse('${rating.averageRating}'),

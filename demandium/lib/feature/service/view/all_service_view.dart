    ...
    if (fromPage == 'popular_services') {
                ...
                children: [
                  if (ResponsiveHelper.isDesktop(context))
                    Padding(
                      ...
                      child: TitleWidget(title: 'popular_services'.tr),
                    ),
                  PaginatedListView(
                    scrollController: scrollController,
                    totalSize:
                ...
                children: [
                  if (ResponsiveHelper.isDesktop(context))
                    Padding(
                      ...
                      child: TitleWidget(title: 'trending_services'.tr),
                    ),
                  PaginatedListView(
                    scrollController: scrollController,
                ...
                children: [
                  if (ResponsiveHelper.isDesktop(context))
                    Padding(
                      ...
                      child: TitleWidget(title: 'recently_view_services'.tr),
                    ),
                  PaginatedListView(
                    scrollController: scrollController,
                    totalSize:
      ...
      return GetBuilder<ServiceController>(
        initState: (state) {
          ...
          Get.find<ServiceController>().getCampaignBasedServiceList(
            widget.campaignID ?? "",
            true,
          );
        },
        builder: (serviceController) {
          return _buildWidget(
            serviceController.campaignBasedServiceList,
            context,
          );
        },
      );
                ...
                children: [
                  if (ResponsiveHelper.isDesktop(context))
                    Padding(
                      ...
                      child: TitleWidget(title: 'recommended_for_you'.tr),
                    ),
                  PaginatedListView(
                    scrollController: scrollController,
                    totalSize:
              ...
              child: Column(
                children: [
                  ...
                  PaginatedListView(
                    ...
                    onPaginate: (int offset) async => await serviceController
              ...
              child: Column(
                children: [
                  ...
                  PaginatedListView(
                    ...
                    offset: serviceController
                        .subcategoryBasedServiceContent
                        ?.currentPage,
                    onPaginate: (int offset) async {
                      return await serviceController
            ...
            ? Padding(
                ...
                child: CustomScrollView(
                  ...
                  slivers: [
                    ...
                    const SliverToBoxAdapter(
                      child: SizedBox(height: Dimensions.webCategorySize),
                    ),
                  ],
                ),
              )

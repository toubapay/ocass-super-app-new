...
class _CustomTextFormFieldState extends State<CustomTextFormField> {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      cursorColor: Get.isDarkMode ? Theme.of(context).textTheme.bodyMedium!.color! : Theme.of(context).colorScheme.primary,
      ...
      decoration: widget.inputDecoration ?? InputDecoration(
        ...
        fillColor: widget.fillColor ?? Theme.of(context).cardColor.withValues(alpha: 0.2),
  ...
  OutlineInputBorder getBorder() => OutlineInputBorder(
    borderRadius: BorderRadius.circular(widget.outlineInputBorderRadius ?? 10.0),
    borderSide: BorderSide(
      style: widget.isShowBorder ? BorderStyle.solid : BorderStyle.none,
      width: widget.isShowBorder ?  1 : 0,
      color: widget.outlineInputBorderColor ?? Theme.of(context).colorScheme.primary.withValues(alpha: 0.3),
    ),
  );
}

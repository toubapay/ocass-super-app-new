  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Container(
          ...
          child: Image.asset(
            (type == NoDataType.cart || type == NoDataType.order)
                ...
                ? Images.emptySearchService
                : type == NoDataType.provider
                ? Images.emptyProvider
                : type == NoDataType.inbox
                ? Images.chatImage
                : type == NoDataType.transaction
                ? Images.emptyTransaction
                : type == NoDataType.offers
                ? Images.emptyOffer
                : Images.emptyService,
            width: type == NoDataType.coupon
                ? 50.0
                : MediaQuery.of(context).size.height * 0.1,
            height: type == NoDataType.coupon
                ? 50.0
                : MediaQuery.of(context).size.height * 0.1,
            color:
                Get.isDarkMode &&
        ...
        Padding(
          ...
          child: Text(
            ...
            style: robotoMedium.copyWith(
              ...
              color: Theme.of(
                context,
              ).textTheme.bodyLarge!.color!.withValues(alpha: .4),
            ),
        ...
        if (type != NoDataType.categorySubcategory &&
            type != NoDataType.inbox &&
            type != NoDataType.bookings &&
            type != NoDataType.service &&
            type != NoDataType.search &&
